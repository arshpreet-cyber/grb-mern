            ...
            >
              ...
              <div className="mt-auto mb-[20px]">
                ...
                {isEditing ? (
                  ...
                  <h3 className="font-semibold text-lg text-[#000000]">{step.title}</h3>
                )}

                {/* Desc */}
                {isEditing ? (
                  <textarea
                    className="mt-3 text-[#000000B2] text-sm leading-relaxed w-full outline-none border-b border-dashed border-[#fc0] bg-transparent resize-none"
                    rows={4}
                    value={step.desc}
