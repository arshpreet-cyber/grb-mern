  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[1210] flex h-[52px] w-[52px] items-center justify-center rounded-full bg-[#111111] text-white shadow-[0_8px_32px_rgba(0,0,0,0.35)] transition-all duration-200 hover:scale-105 active:scale-95"
      >
        <ShoppingCart size={22} strokeWidth={1.8} />
        <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#ff5a7a] text-[10px] font-bold text-white shadow ring-2 ring-white">
          {visibleCount}
        </span>
      </button>
