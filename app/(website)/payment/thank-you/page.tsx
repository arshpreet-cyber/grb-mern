        ...
        <Wrapper>
          ...
          <div className="flex justify-center mb-[60px] pt-[10px]">
            <div className="relative flex justify-between w-[600px] max-w-full">
              <div className="absolute top-[25px] left-[40px] w-[87%] h-[2px] z-0 flex">
                <div className="bg-[#fcd535] flex-1" />
                <div className="bg-[#fcd535] flex-1" />
              </div>
              {steps.map((step) => (
                <div key={step.number} className="relative z-[2] text-center w-[120px]">
                  <div className="w-[50px] h-[50px] rounded-full flex items-center justify-center border-2 mx-auto mb-[10px] font-semibold text-[18px] bg-[#fcd535] border-[#fcd535] text-[#212529]">
                    {step.number}
                  </div>
          ...
          <div className="bg-white rounded-[11px] p-[50px] max-w-2xl mx-auto text-center shadow-sm">
            ...
            <p className="text-[15px] text-[#6c757d] mb-8">
              Your payment was successful and our team has been notified. You will receive an email confirmation shortly.
            </p>
