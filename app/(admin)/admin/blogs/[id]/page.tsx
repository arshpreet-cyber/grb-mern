...
export default function EditBlog({ params }: { params: Promise<{ id: string }> }) {
      ...
      try {
        ...
        if (data.success && data.blog) {
          ...
          setFormData({
            ...
            canonical_link: b.canonical_link || "",
            media: b.media || "",
            author: b.author || "",
  ...
  if (fetching) return <div className="p-8 text-center">Loading blog...</div>;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div>
              ...
              {/* Force TipTap Editor to remount with initial content if we use a key, but state sync usually handles it. */}
