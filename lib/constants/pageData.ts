export const HOW_IT_WORKS_DATA = {
  hero: {
    title: "Climb The Ladder Of Business Success With Us!",
    highlightedText: "Success With Us!",
    content: "Whether you're just starting out or looking to expand your brand's image and reach, our team is here to guide you at every stage of your growth.",
...
export const HOME_PAGE_DATA = {
  visibilitySection: {
    title: "Turn Reviews into Brand Visibility and Growth",
    content: [
